...
| Task 17 acceptance close-out | **Mostly done**: evidence recorded for all 67 acceptance criteria, recounted 2026-09-01 into 75 rows. 2026-09-02: `NOT_RUN` rows closed by writing tests, `AC-EXPORT-05` removed by product decision, three `PENDING_DECISION` items settled. 2026-09-03/04: **Gate A run for real** against a Cloudflare account — 2 criteria newly `PENDING_DECISION` from real numbers (`AC-CONTENT-02b/10`). 2026-09-05: `AC-CONTENT-10` settled and implemented (a content-length safety net). Now: 66 criteria in 74 rows: 59 verified locally, **4 verified on a real account** (`AC-DEPLOY-01/04/07b`, `AC-MEDIA-04`), 1 `PENDING_DECISION` (`AC-CONTENT-02b`), 10 still needing a real account for other reasons. See `ACCEPTANCE.md §14` |
