/**
 * The request router. Routes by path prefix (docs/ARCHITECTURE.md §3):
 *
...
/**
 * The handler a Mallok deployment exports.
 *
 * Built here rather than exported as a `default` so that the entry module of
 * a generated project can declare its composition first
 * (`createMallok`, `framework.ts`).
 */
export const mallokHandler: ExportedHandler<Env> = {
  fetch: fetchHandler,
