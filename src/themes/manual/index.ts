/** The `manual` theme: documentation with a contents rail. */
...
import sidebarLiquid from './partials/sidebar.liquid';
import manifestJson from './theme.json';

/** Parsed and validated manifest. */
export const manualManifest = parseThemeManifest(manifestJson);

/** Text files of the theme, keyed by path inside it. */
export const manualFiles: ThemeFiles = {
  ...
  'partials/sidebar.liquid': sidebarLiquid,
